    ...
    return (
        <div className="max-w-4xl mx-auto p-4 md:p-6">
            <div className="flex flex-col items-center justify-center py-32 text-center gap-4">
                ...
                <div>
                    <p className="text-lg font-bold text-slate-700">부품 데이터를 불러오지 못했습니다</p>
                    <p className="text-sm text-slate-400 mt-1">서버 연결 오류입니다. 잠시 후 다시 시도해 주세요.</p>
                    {error.digest && (
                        <p className="text-xs text-slate-300 mt-1">Digest: {error.digest}</p>
                    )}
                </div>
                <button
                    onClick={reset}
