...
3. isDelivery: 아래 중 하나라도 해당하면 true. 아무것도 해당하지 않으면 false.
   - true인 경우: 납품 일정 확정, 납품일/납기일 변경(예: "납기일변경 7/30", "납품일 8/15로 변경"), 설치 예약, 배송 예정, 납품 예정 날짜 언급 등 납품·설치 스케줄과 직접 관련된 내용
   - false인 경우: 단순 AS 방문, 점검, 클레임 접수, 전화 통화 기록, 견적 문의 등 납품 일정과 무관한 내용
